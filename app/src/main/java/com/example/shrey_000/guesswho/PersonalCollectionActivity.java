...
public class PersonalCollectionActivity extends AppCompatActivity implements ISpeechDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tab_stt_fragment);

        initSTT();
//        Log.d("thullu", "initialized");
